...
interface Emits {
  ...
  (e: 'cell-select', payload: { employeeId: string; date: string }): void;
}
...
function handleConstraintSelect(payload: { employeeId: string; date: string }) {
...
function getCellClass(date: GridColumn, employeeId: string) {
  return {
